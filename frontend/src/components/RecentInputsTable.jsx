            ...
            <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                    <tr>
                        ...
                        <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Antal säckar</th>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                    {entries.map((entry, idx) => {
                        ...
                        return (
                            <tr key={key}>
                                <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-700">{formatDate(entry.date)}</td>
                                <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-700">{entry.numberOfSacks}</td>
